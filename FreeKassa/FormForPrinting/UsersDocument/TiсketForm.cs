...
namespace FreeKassa.FormForPrinting.UsersDocument
{
    ...
    {
        public static byte[] GetTicketForm(EPSON vkp80ii, TicketModel tiket)
        {
            return ByteSplicer.Combine(
                vkp80ii.LeftAlign(),
                vkp80ii.PrintImage(File.ReadAllBytes("Resources/Images/ArlekinLogo.jpg"), false, isLegacy: true),
                vkp80ii.PrintLine(""),
                vkp80ii.PrintLine(""),
                vkp80ii.CenterAlign(),
