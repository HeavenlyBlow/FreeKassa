...
public class ChequeInfo : FiscalParamBase
{
    ...
    // public FiscalParamBase FiscalParams { get; set; }

    [JsonProperty("validateMarks")]
    public List<ValidateMark> ValidateMarks { get; set; }
}
...
// Root myDeserializedClass = JsonConvert.DeserializeObject<Root>(myJsonResponse);
    ...
    public class OnlineValidation
    {
        ...
        [JsonProperty("markOperatorResponse")]
...
public class ValidateMark
    {
        ...
        [JsonProperty("offlineValidation")]
